...
const demo: Demo[] = [
  ...
  { codigo: "CD-5162", nombre: "Guadalupe Hernández", rangoEdad: "70+", sitio: null, completed: ["correo-1", "correo-2", "correo-3", "correo-4", "correo-5", "whatsapp-1", "whatsapp-2", "whatsapp-3"], started: [], minutos: 52 },
  ...
  { codigo: "CD-3519", nombre: "Antonio Gómez", rangoEdad: "60-69", sitio: null, completed: ["seguridad-1", "seguridad-2", "seguridad-3", "seguridad-4"], started: [], minutos: 33 },
  { codigo: "CD-4406", nombre: "Carmen Díaz", rangoEdad: "70+", sitio: null, completed: ["correo-1", "correo-2"], started: ["correo-3"], minutos: 11 },
  ...
  { codigo: "CD-2291", nombre: "Juana Flores", rangoEdad: "70+", sitio: null, completed: [], started: ["correo-1"], minutos: 3 },
  ...
  { codigo: "CD-3348", nombre: "Alicia Mendoza", rangoEdad: "70+", sitio: null, completed: ["correo-1", "whatsapp-1", "seguridad-1"], started: ["tramites-1"], minutos: 18 },
